...
Intuition & Thoughts:   This is an example of a problem that is worded in a confusing way to throw off the solver. We are asked to find any peak element. A peak
